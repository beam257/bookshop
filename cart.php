                            ...
                            <?php if($rows > 0): ?>
                                ...
                                <tr>
                                    <td colspan="6" class="text-end">
                                        <button type="submit" class="btn btn-lg btn-success">อัพเดทตะกร้า</button>
                                        <a href= "index1.php"></a>
                                        <a href="<?php echo $base_url; ?>/checkout.php" class="btn btn-lg btn-primary">ต่อไป</a>
                                    </td>
                                </tr>
                            <?php else: ?>
                            <tr>
