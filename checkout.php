                ...
                <div class="col-md-6 col-lg-7">                
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="file" name="picture" class="form-control" placeholder="" value="">                            
                        </div>
                    </div>
                    <hr class="my-4">
                    <div class="text-end">
                        <a href="<?php echo $base_url; ?>/cart.php" class="btn btn-secondary btn-lg" role="button">ย้อนกลับ</a>
                        <button class="btn btn-primary btn-lg" type="submit">เสร็จสิ้น</button>
                    </div>                
                </div>
                <div class="col-md-6 col-lg-5 order-md-last">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        <span class="text-primary">จำนวนเงินที่ต้องชำระ</span>
                    ...
                    <center><img src = "https://scontent.fbkk10-1.fna.fbcdn.net/v/t1.15752-9/379583420_699188628739616_4643014814959274283_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=ae9488&_nc_eui2=AeHxfbYRcUx_XWsLFGQZGGrhJmCq429rlJsmYKrjb2uUm-ORiSCCyDoBx2FPHab1LdDdPZpiKeWVDk5gpP50K3I6&_nc_ohc=ma39i8jCBzoAX-UJZxd&_nc_ht=scontent.fbkk10-1.fna&oh=03_AdSUC7IHgMYQNNxM2M93h2BsjHDZoQklG1SqG2-cqatEMg&oe=653C9F73" width="130px" >
